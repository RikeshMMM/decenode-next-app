...
import RevealWhenVisible from "../components/RevealWhenVisible";
            ...
            <div className="row text-center text-sm-start align-items-center justify-content-center flex-row-reverse py-3">
              ...
              <div className="col-sm-8">
                ...
                <FadeInWhenVisible>
                  ...
                  <a
                    href="https://discord.gg/bkBbUpaBk6"
              ...
              <div className="col-sm-8">
                ...
                <FadeInWhenVisible>
                  <p className="text-secondary lead my-3">
                    ...
                    <span className="text-primary">cost efficient</span>{" "}
                    computation power by{" "}
                    <span className="text-primary">utilizing idle</span>{" "}
                    computers via a{" "}
        ...
        <section id="features-section">
          <div className="container">
            <div className="text-center py-3">
              ...
              <FadeInWhenVisible>
                <p className="text-secondary lead my-3">
                  Our unique features makes us different from others while
                  offering the best to our users
                </p>
              </FadeInWhenVisible>
